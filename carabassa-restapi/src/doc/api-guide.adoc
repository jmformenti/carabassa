...
===== Links
include::{snippets}/get-items/links.adoc[]
...
=== Get item content
Get an item content from a dataset.

==== Request

===== Path parameters
include::{snippets}/get-item-content/path-parameters.adoc[]

===== Example
include::{snippets}/get-item-content/http-request.adoc[]

===== CURL request
include::{snippets}/get-item-content/curl-request.adoc[]

==== Response

===== Example
include::{snippets}/get-item-content/http-response.adoc[]
