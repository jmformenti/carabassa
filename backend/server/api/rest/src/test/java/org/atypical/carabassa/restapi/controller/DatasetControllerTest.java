...
public class DatasetControllerTest extends DatasetControllerHelper {
        ...
        private final String FAKE_IMG_PATH = "images/fake_test.jpg";
        ...
        private FieldDescriptor[] getItemDescriptor() {
                return new FieldDescriptor[] { fieldWithPath("id").description("Item identifier"),
                                fieldWithPath("type").description("Item type"),
                                fieldWithPath("format").description("Item format"),
        ...
        private FieldDescriptor[] getTagEditableDescriptor() {
                return new FieldDescriptor[] { fieldWithPath("name").description("Tag name"),
                                fieldWithPath("value").description("Tag value"), subsectionWithPath("boundingBox")
                                                .description("Bounding box related")
                                                .type(BoundingBoxRepresentation.class) };
        }
        ...
        public void createDataset() throws Exception {
                String json = objectMapper
                                .writeValueAsString(new DatasetEditableRepresentation(DATASET_NAME, "description"));
                ...
                mvc.perform(post("/api/dataset") //
                                ...
                                .andDo(document("create", //
                                                ...
                                                responseFields(fieldWithPath("id")
                                                                .description("New dataset identifier"))));
        }

        @Test
        public void findAllDatasets() throws Exception {
                Page<Dataset> page = new PageImpl<>(List.of(new DatasetImpl()), PageRequest.of(2, 10), 100L);
                                ...
                                .andDo(document("find-all", //
                                                ...
                                                responseFields(
                                                                subsectionWithPath("_links")
                                                                                ...
                                                                                .type(Links.class),
                                                                subsectionWithPath(
                                                                                "_embedded.datasetEntityRepresentationList[]")
        ...
        public void findByDatasetName() throws Exception {
                ...
                mvc.perform(get("/api/dataset/name/{datasetName}", DATASET_NAME)) //
                                ...
                                .andDo(document("find-by-name", //
                                                pathParameters(parameterWithName("datasetName")
        ...
        public void findItems() throws Exception {
                when(datasetService.findById(DATASET_ID)).thenReturn(dataset);
                Page<IndexedItem> page = new PageImpl<>(new ArrayList<>(dataset.getItems()), PageRequest.of(2, 10),
                                100L);
                                ...
                                .andDo(document("find-items", //
                                                ...
                                                responseFields(
                                                                subsectionWithPath("_links")
                                                                                .description("Links to other resources")
                                                                                .type(Links.class),
                                                                subsectionWithPath("_embedded.itemRepresentationList[]")
        ...
        public void findDatasetItemTagValuesByName() throws Exception {
                ...
                mvc.perform(get("/api/dataset/{datasetId}/item/tag/{tagName}/values?page=0&size=10", DATASET_ID,
                                TAG_NAME)) //
                                .andExpect(status().isOk());
        }
        ...
        void existsItem() throws Exception {
                ...
                mvc.perform(get("/api/dataset/{datasetId}/item/exists/{hash}", DATASET_ID, ITEM_HASH)) //
                                ...
                                .andDo(document("exists-item",
                                                pathParameters(parameterWithName("datasetId")
                                                                .description("Dataset identifier"),
                                                                parameterWithName("hash").description(
                                                                                "Item hash (hexadecimal md5 digest)"))));
        }
        ...
        public void addItem() throws Exception {
                ...
                when(datasetService.findById(DATASET_ID)).thenReturn(dataset);
                when(datasetService.addItem(isA(Dataset.class), isA(ItemType.class), isA(String.class),
                                isA(Resource.class)))
        ...
        public void reindex() throws Exception {
                when(datasetService.findById(DATASET_ID)).thenReturn(dataset);
                when(datasetService.findItemById(dataset, ITEM_ID)).thenReturn(indexedItem);
                doNothing().when(datasetService).reindex(dataset, ITEM_ID);

                mvc.perform(put("/api/dataset/{datasetId}/item/{itemId}/reindex", DATASET_ID, ITEM_ID)) //
                                .andExpect(status().isNoContent()) //
                                .andDo(document("reindex-item",
                                                pathParameters(parameterWithName("datasetId")
                                                                .description("Dataset identifier"),
                                                                parameterWithName("itemId")
                                                                                .description("Item identifier"))));
